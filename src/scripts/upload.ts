...
async function pbClient() {
  ...
  if (!username || !password) throw new Error("Please set POCKETBASE_USERNAME & POCKETBASE_PASSWORD");
...
async function connect() {
  ...
  if (apiId === 0 || !apiHash || !BOT_TOKEN) throw new Error("Please set TELEGRAM_API_ID & TELEGRAM_API_HASH & TELEGRAM_BOT_TOKEN");
